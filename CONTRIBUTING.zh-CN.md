...
感谢你对 Well Insight UI 的关注！

## 贡献方式

- **报告 Bug** — 在 [Issues](https://github.com/well-insight/well-insight-ui/issues) 中提供复现步骤。
...
1. 阅读 [在线文档](https://well-insight.github.io/well-insight-ui/)。
...
如果不确定改动是否合适，请先 [提 Issue](https://github.com/well-insight/well-insight-ui/issues) 讨论，避免在大改动上白费功夫。
