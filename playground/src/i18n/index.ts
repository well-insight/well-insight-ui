...
const messages = {
  'zh-CN': {
    ...
    viewNpm: '在 npm 上查看',
    installTitle: '安装',
    installHint: '兼容 Vue 3.3+（推荐 3.5+）。支持全量注册、按名导入与按需子路径。',
    techTags: '技术标签',
    capabilities: '特性',
    next: '探索文档',
  ...
  'en-US': {
    ...
    installHint: 'Compatible with Vue 3.3+ (3.5+ recommended). Full registration, named imports, and on-demand subpaths are supported.',
    techTags: 'Tech tags',
