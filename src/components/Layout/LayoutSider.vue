...
const fullWidth = computed(() => toCssLength(props.width) ?? '272px')
...
const scrollClass = computed(() => ['wi-layout-sider__scroll', props.contentClass])
...
<template>
  ...
  >
    ...
    <button
      ...
      :class="[
        triggerClass,
        {
          ...
          'wi-layout-sider__trigger--arrow-circle': triggerKind === 'arrow-circle',
        },
      ]"
      :style="triggerStyle"
      ...
      @click="toggle"
    >
      <span v-if="triggerKind === 'arrow-circle'" class="wi-layout-sider__arrow" aria-hidden="true">
        ›
      </span>
    ...
    <div v-if="bordered" class="wi-layout-sider__border" aria-hidden="true" />
  </aside>
</template>
