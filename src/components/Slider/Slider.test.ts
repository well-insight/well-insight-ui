...
describe('wdSlider', () => {
  ...
  it('marks disabled state', () => {
    ...
    expect(wrapper.get('.wd-slider').classes()).toContain('wd-slider--disabled')
  ...
  it('renders marks and vertical layout', () => {
    ...
    expect(wrapper.get('.wd-slider').classes()).toEqual(
      expect.arrayContaining(['wd-slider--vertical', 'wd-slider--tooltip']),
    )
