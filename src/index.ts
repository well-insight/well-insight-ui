...
export type { WiComponentDefaults, WiDensity, WiGlobalConfig, WiLocaleConfig } from './components/ConfigProvider/types'
...
export type { DialogClickGuard, DialogCloseGuard, DialogEmits, DialogPosition, DialogProps, DialogType } from './components/Dialog/types'
