...
export type WiRouteLocationRaw = string | Record<string, unknown>
...
export function resolveRouteHref(to: WiRouteLocationRaw): string {
...
export function isExternalRoute(to: WiRouteLocationRaw): boolean {
  if (typeof to === 'string') {
